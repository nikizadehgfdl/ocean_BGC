...
!
    ...
    !nh3
!This cannot be inside do concurrent 
!NVFORTRAN-S-0488-Subprogram call in DO CONCURRENT is not PURE - calc_pka_nh3
...
!    do k = 1, nk ; do j = jsc, jec ; do i = isc, iec   !{
    ...
    !
       if (co2_calc == "ocmip2") then
        ...
        print*,"Unable to compute aragonite and calcite saturation states"
...
!
    ...
    call g_tracer_set_values(tracer_list,'nh3',    'field',f_nh3      ,isd,jsd,ntau=1)
    call g_tracer_set_values(tracer_list,'co3_ion','field',f_co3_ion  ,isd,jsd,ntau=1)
...
!
  ...
  subroutine user_allocate_arrays
    ...
    allocate(f_nh3(isd:ied, jsd:jed, 1:nk))        ; f_nh3=0.0
