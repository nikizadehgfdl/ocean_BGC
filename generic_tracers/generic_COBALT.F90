...
write (stdlogunit, generic_COBALT_nml)
  ...
  subroutine generic_COBALT_init(tracer_list, force_update_fluxes_in)
    ...
    id_clock_doloops = mpp_clock_id('(Cobalt: doloops)' ,grain=CLOCK_MODULE)
...
!    real                                  :: conversion 
    ...
    id_net_phyto_resp = register_diag_field(package_name, vardesc_temp%name, axes(1:3),&
         init_time, vardesc_temp%longname,vardesc_temp%units, missing_value = missing_value1)
...
! CAS added a "plus_btm" version of jprod_nh4 to use for the remoc CMIP variable
    ...
    id_jfe_iceberg = register_diag_field(package_name, vardesc_temp%name, axes(1:3),&
         init_time, vardesc_temp%longname,vardesc_temp%units, missing_value = missing_value1)

    vardesc_temp = vardesc("jno3_iceberg","iceberg nitrate efflux layer integral",'h','L','s','mol N m-2 s-1','f')
    id_jno3_iceberg = register_diag_field(package_name, vardesc_temp%name, axes(1:3),&
         init_time, vardesc_temp%longname,vardesc_temp%units, missing_value = missing_value1)

    vardesc_temp = vardesc("jpo4_iceberg","iceberg phosphate efflux layer integral",'h','L','s','mol P m-2 s-1','f')
    id_jpo4_iceberg = register_diag_field(package_name, vardesc_temp%name, axes(1:3),&
         init_time, vardesc_temp%longname,vardesc_temp%units, missing_value = missing_value1)
    ...
    id_jprod_no3nitrif = register_diag_field(package_name, vardesc_temp%name, axes(1:3),&
         init_time, vardesc_temp%longname,vardesc_temp%units, missing_value = missing_value1)

    vardesc_temp = vardesc("juptake_nh4nitrif","NH4 uptake via Nitrification layer integral",'h','L','s','mol m-2 s-1','f')
    id_juptake_nh4nitrif = register_diag_field(package_name, vardesc_temp%name, axes(1:3),&
         init_time, vardesc_temp%longname,vardesc_temp%units, missing_value = missing_value1)
    ...
    id_jprod_n2amx = register_diag_field(package_name, vardesc_temp%name, axes(1:3),&
	     init_time, vardesc_temp%longname,vardesc_temp%units, missing_value = missing_value1)

    vardesc_temp = vardesc("juptake_nh4amx","NH4 uptake via Anammox layer integral",'h','L','s','mol m-2 s-1','f')
    id_juptake_nh4amx = register_diag_field(package_name, vardesc_temp%name, axes(1:3),&
             init_time, vardesc_temp%longname,vardesc_temp%units, missing_value = missing_value1)

    vardesc_temp = vardesc("juptake_no3amx","NO3 uptake via Anammox layer integral",'h','L','s','mol m-2 s-1','f')
    id_juptake_no3amx = register_diag_field(package_name, vardesc_temp%name, axes(1:3),&
             init_time, vardesc_temp%longname,vardesc_temp%units, missing_value = missing_value1)
    ...
    id_runoff_flux_pdet = register_diag_field(package_name, vardesc_temp%name, axes(1:2),&
         init_time, vardesc_temp%longname,vardesc_temp%units, missing_value = missing_value1)
...
! CAS: Added diagnostic for diatom NPP in top 100m for CMIP
    ...
    id_wc_vert_int_chemoautopp = register_diag_field(package_name, vardesc_temp%name, axes(1:2),&
         init_time, vardesc_temp%longname,vardesc_temp%units, missing_value = missing_value1)
    ...
    id_wc_vert_int_net_phyto_resp = register_diag_field(package_name, vardesc_temp%name, axes(1:2),&
         init_time, vardesc_temp%longname,vardesc_temp%units, missing_value = missing_value1)

    vardesc_temp = vardesc("wc_vert_int_npp","Water column net primary production vertical integral",'h','1','s','mol N m-2 s-1','f')
    id_wc_vert_int_npp = register_diag_field(package_name, vardesc_temp%name, axes(1:2),&
         init_time, vardesc_temp%longname,vardesc_temp%units, missing_value = missing_value1)
    ...
    id_wc_vert_int_jprod_no3nitrif = register_diag_field(package_name, vardesc_temp%name, axes(1:2),&
         init_time, vardesc_temp%longname,vardesc_temp%units, missing_value = missing_value1)

    vardesc_temp = vardesc("wc_vert_int_jprod_n2amx","Water column N2 from anammox vertical integral",'h','1','s','mol m-2 s-1','f')
    id_wc_vert_int_jprod_n2amx = register_diag_field(package_name, vardesc_temp%name, axes(1:2),&
         init_time, vardesc_temp%longname,vardesc_temp%units, missing_value = missing_value1)
    ...
    id_wc_vert_int_jfe_iceberg = register_diag_field(package_name, vardesc_temp%name, axes(1:2),&
         init_time, vardesc_temp%longname,vardesc_temp%units, missing_value = missing_value1)

    vardesc_temp = vardesc("wc_vert_int_jno3_iceberg","iceberg nitrate, vertical integral",'h','1','s','mol N m-2 s-1','f')
    id_wc_vert_int_jno3_iceberg = register_diag_field(package_name, vardesc_temp%name, axes(1:2),&
         init_time, vardesc_temp%longname,vardesc_temp%units, missing_value = missing_value1)

    vardesc_temp = vardesc("wc_vert_int_jpo4_iceberg","iceberg phosphate, vertical integral",'h','1','s','mol P m-2 s-1','f')
    id_wc_vert_int_jpo4_iceberg = register_diag_field(package_name, vardesc_temp%name, axes(1:2),&
         init_time, vardesc_temp%longname,vardesc_temp%units, missing_value = missing_value1)
...
!==============================================================================================================
  ...
  subroutine user_add_params
    ...
    call g_tracer_add_param('no3_2_nh4_amx', no3_2_nh4_amx, &
...
!    call g_tracer_add_param('o2_2_nfix', o2_2_nfix, (118.0+3.0/(5.0+3.0)*(150.0-118.0))/16.0) ! mol O2 mol N-1
    ...
    call g_tracer_add_param('o2_2_nitrif', o2_2_nitrif, &
    ...
    call g_tracer_add_param('alk_2_nh4_amx', alk_2_nh4_amx, 3732.0/8030.0)           ! eq. alk mol NH4-1
    call g_tracer_add_param('alk_2_nh4_nit', alk_2_nh4_nit, 7436.0/3726.0)           ! eq. alk mol NH4-1
    ...
    call g_tracer_add_param('ca_2_n_arag', ca_2_n_arag, 0.040 * 106.0 / 16.0)        ! mol Ca mol N-1
    call g_tracer_add_param('ca_2_n_calc', ca_2_n_calc, 0.014 * 106.0 / 16.0)        ! mol Ca mol N-1
    ...
    call g_tracer_add_param('jfe_iceberg_ratio', jfe_iceberg_ratio,1.0e-7)            ! mol Fe kg-1 ice melt
    call g_tracer_add_param('jno3_iceberg_ratio', jno3_iceberg_ratio,2.0e-6)          ! mol N kg-1 ice melt
    call g_tracer_add_param('jpo4_iceberg_ratio', jpo4_iceberg_ratio,1.1e-7)          ! mol P kg-1 ice melt
    ...
    call g_tracer_add_param('knh4_nitrif',  k_nh3_nitrif, k_nh3_nitrif )                     ! moles kg-1
    call g_tracer_add_param('irr_inhibit',  irr_inhibit, irr_inhibit)                         ! W m-2
    call g_tracer_add_param('gamma_nh4amx',  gamma_nh4amx, 0.07 / sperd)                      ! s-1
    call g_tracer_add_param('o2_min_amx', o2_min_amx, 4.0e-6 )                                ! mol O2 kg-1
    !
    !-----------------------------------------------------------------------
    ! Miscellaneous
    !-----------------------------------------------------------------------
...
!
    ...
    call mpp_clock_begin(id_clock_doloops)
    ! zero out cumulative COBALT-wide production diagnostics

!     do k = 1, nk  ; do j = jsc, jec ; do i = isc, iec
!!$ACC set device_num(1)
!!$ACC data copy(cobalt,phyto,bact,zoo) copyin(temp,grid_tmask,z_remin_ramp)
!!$ACC set device_num(0)
!!$ACC data copy(cobalt,phyto,bact,zoo) copyin(temp,grid_tmask,z_remin_ramp)

!!$OMP parallel do private(gpudevice,k) !did not work
...
!kernels
!!$ACC kernels copy(cobalt,phyto,bact,zoo) copyin(temp,grid_tmask,z_remin_ramp)
...
!    do k = 1, nk ; do j = jsc, jec ; do i = isc, iec   !{
       ...
       net_phyto_resp(i,j,k) = net_phyto_resp(i,j,k) - min(0.0,phyto(n)%mu(i,j,k)*phyto(n)%f_n(i,j,k))
!!$ACC loop
       do n = 2, NUM_PHYTO !{
...
!    do k = 1, nk ; do j = jsc, jec ; do i = isc, iec   !{
       ...
       if (f_o2(i,j,k) .lt. o2_min_amx) then !{
         !
         ! Anammox Reaction: here we convert ammonia and nitrate to dinitrogen
         ! Here, Anammox is NO3 dependent
         !
         juptake_nh4amx(i,j,k) = gamma_nh4amx * &
            f_no3(i,j,k) / ((phyto(SMALL)%k_no3 * 3.0) + f_no3(i,j,k)) * &
            f_nh4(i,j,k)

         juptake_no3amx(i,j,k) = juptake_nh4amx(i,j,k)*&
            no3_2_nh4_amx

         ! bacteria production from anammox:
         bact(1)%jprod_n_amx(i,j,k) = min(juptake_nh4amx(i,j,k)*bact(1)%amx_ge, &
                                        0.5*f_po4(i,j,k)/(dt*bact(1)%q_p_2_n))
         bact(1)%juptake_po4(i,j,k) = bact(1)%jprod_n_amx(i,j,k)*bact(1)%q_p_2_n
         jprod_n2amx(i,j,k) = juptake_nh4amx(i,j,k) + juptake_no3amx(i,j,k) - &
                                       bact(1)%jprod_n_amx(i,j,k)
       else
         juptake_nh4amx(i,j,k) = 0.0
         juptake_no3amx(i,j,k) = 0.0
         bact(1)%jprod_n_amx(i,j,k) = 0.0
         bact(1)%juptake_po4(i,j,k) = 0.0
         jprod_n2amx(i,j,k) = 0.0
       endif !}
       ...
       if (scheme_nitrif .eq. 2 .or. scheme_nitrif .eq. 3) then
          if (f_o2(i,j,k) .gt. o2_min_nit) then  !{
             ...
             if (scheme_nitrif .eq. 3) then
                juptake_nh4nitrif(i,j,k) = juptake_nh4nitrif(i,j,k)*expkT(i,j,k)
             end if
          end if
       elseif (scheme_nitrif .eq. 1) then
          if (f_o2(i,j,k) .gt. o2_min) then  !{
             juptake_nh4nitrif(i,j,k) = gamma_nitrif * expkT(i,j,k) * f_nh4(i,j,k) * &
                  phyto(SMALL)%nh4lim(i,j,k) * (1.0 - f_irr_mem(i,j,k) / &
                  (irr_inhibit + f_irr_mem(i,j,k))) * f_o2(i,j,k) / &
                  ( k_o2 + f_o2(i,j,k) )
          end if
       end if
       jo2resp_wc(i,j,k) = jo2resp_wc(i,j,k)+juptake_nh4nitrif(i,j,k)*o2_2_nitrif

       ! bacterial production from nitrifying bacteria
       bact(1)%jprod_n_nitrif(i,j,k) = min(juptake_nh4nitrif(i,j,k)*bact(1)%nitrif_ge, &
                                        0.5*f_po4(i,j,k)/(dt*bact(1)%q_p_2_n))
       bact(1)%juptake_po4(i,j,k)=bact(1)%juptake_po4(i,j,k) + &
               bact(1)%jprod_n_nitrif(i,j,k)*bact(1)%q_p_2_n
       jprod_no3nitrif(i,j,k) = juptake_nh4nitrif(i,j,k) - bact(1)%jprod_n_nitrif(i,j,k)
...
!    do k = 1, nk  ; do j = jsc, jec ; do i = isc, iec   !{
       ...
       bact(1)%jprod_n_het(i,j,k) = bact(1)%gge_max*bact(1)%juptake_ldon(i,j,k) - &
          bact(1)%bhet(i,j,k)/(refuge_conc + bact(1)%bhet(i,j,k)) * & 
...
!    call mpp_clock_begin(id_clock_zooplankton_calculations)
    ...
    prey_si2n_vec(6) = 0.0
    prey_si2n_vec(7) = 0.0
!!$ACC loop private(m,sw_fac_denom,tot_prey_hp,tot_prey,prey_vec,pa_matrix,ingest_matrix,hp_ingest_vec,hp_pa_vec,prey_fe2n_vec,prey_si2n_vec,prey_p2n_vec) collapse(3)
    do k = 1, nk ;do j = jsc, jec ; do i = isc, iec
       !
    ...
    enddo; enddo; enddo  !} i,j,k
!!$ACC end kernels !kernels4   crawls since the above ijk loop could not be parallelized.
...
!!$ACC kernels copy(cobalt,phyto,bact,zoo,pre_totn,pre_totc,net_srcn,net_srcp,pre_totp,pre_totfe,net_srcfe,pre_totsi) copyin(temp,grid_tmask,z_remin_ramp)
!!$ACC loop independent collapse(3)
!    do k = 1, nk ; do j = jsc, jec ; do i = isc, iec; !{
    do concurrent(k=1:nk,j=jsc:jec,i=isc:iec)     
       !  
...
!!$ACC loop
       do n = 1,NUM_PHYTO !{
            ...
            phyto(n)%agg_lim(i,j,k) = (1.0-min(phyto(n)%f_mu_mem(i,j,k)/ &
                           (phyto(n)%frac_mu_agg*phyto(n)%P_C_max*expkT(i,j,k)),1.0))**2
...
!          assim_eff = 1.0-zoo(m)%phi_det-zoo(m)%phi_ldon-zoo(m)%phi_sldon-zoo(m)%phi_srdon
          ...
          zoo(m)%jprod_n(i,j,k) = min(zoo(m)%jprod_n(i,j,k), &
                                      (1.0-zoo(m)%phi_det-zoo(m)%phi_ldon-zoo(m)%phi_sldon-zoo(m)%phi_srdon)*&
                                      zoo(m)%jingest_p(i,j,k)/zoo(m)%q_p_2_n)
...
!------------------------------------------------------------------------------------
!
!!$ACC loop independent collapse(3) private(TK,PRESS,PKSPA,PKSPC)
!    do k = 1, nk ; do j = jsc, jec ; do i = isc, iec   !{
    do concurrent(k=1:nk,j=jsc:jec,i=isc:iec) local(TK,PRESS,PKSPA,PKSPC)
    !
...
!    do k=1,nk ; do j=jsc,jec ; do i=isc,iec  !{
       ...
       jremin_fedet(i,j,k) = jremin_ndet(i,j,k)* &
         (k_o2 + max(f_o2(i,j,k),o2_min))/max(f_o2(i,j,k),o2_min) / &
         (f_ndet(i,j,k) + epsln) * remin_eff_fedet*f_fedet(i,j,k)
...
!
    ...
    !
!!$ACC loop independent collapse(3) private(feprime_temp,fe_salt)
!    do k = 1, nk ; do j = jsc, jec ; do i = isc, iec   !{
    do concurrent(k=1:nk,j=jsc:jec,i=isc:iec) local(feprime_temp,fe_salt)
       ...
       jfe_ads(i,j,k) = min(jfe_ads(i,j,k),f_fed(i,j,k)/(2.0*dt))
...
!!$ACC loop independent collapse(2)
    ...
    do concurrent(j=jsc:jec,i=isc:iec)
       jfe_iceberg(i,j,1) = jfe_iceberg_ratio*max(frunoff(i,j),0.0)/rho_dzt(i,j,1)
       jno3_iceberg(i,j,1) = jno3_iceberg_ratio*max(frunoff(i,j),0.0)/rho_dzt(i,j,1)
       jpo4_iceberg(i,j,1) = jpo4_iceberg_ratio*max(frunoff(i,j),0.0)/rho_dzt(i,j,1)
       jfe_coast(i,j,1) = fe_coast * mask_coast(i,j) * grid_tmask(i,j,1) / &
            sqrt(grid_dat(i,j))
    enddo !docon
    !enddo; enddo  !} i,j
!!$ACC loop independent collapse(3)
    !do k = 2, nk ; do j = jsc, jec ; do i = isc, iec   !{
    do concurrent(k=2:nk,j=jsc:jec,i=isc:iec)
       jfe_coast(i,j,k) = fe_coast * mask_coast(i,j) * grid_tmask(i,j,k) / &
            sqrt(grid_dat(i,j))
       ! uncomment if running "no mass change" test
       !jfe_coast(i,j,k) = 0.0
       jfe_iceberg(i,j,k) = 0.0
       jno3_iceberg(i,j,k) = 0.0
       jpo4_iceberg(i,j,k) = 0.0
    enddo
    !enddo; enddo; enddo  !} i,j,k

!!$ACC loop independent collapse(2) private(fpoc_btm,log_fpoc_btm)
    !do j = jsc, jec; do i = isc, iec  !{
    do concurrent(j=jsc:jec,i=isc:iec) local(k,fpoc_btm,log_fpoc_btm)
       k = grid_kmt(i,j)
       if (k .gt. 0) then !{
          !
          ...
          if (f_ndet_btf(i,j,1) .gt. 0.0) then !{
             ...
             frac_burial(i,j) = 0.013 + 0.53*fpoc_btm**2.0/((3.5+fpoc_btm)**2.0) * &
                  zt(i,j,k) / (z_burial + zt(i,j,k))

             !increase burial below 500m by 4 fold
             if (zt(i,j,k) .gt. 500.0) then !{
                   frac_burial(i,j) = frac_burial(i,j)*1.7
             endif !}
...
!!$ACC loop independent collapse(3)
    ...
    do concurrent(k=1:nk,j=jsc:jec,i=isc:iec)
         ...
         net_srcn(i,j,k) = (phyto(DIAZO)%juptake_n2(i,j,k) - jno3denit_wc(i,j,k) - &
                    jprod_n2amx(i,j,k) + jno3_iceberg(i,j,k)) * dt*grid_tmask(i,j,k)  
...
!    do k = 1, nk ; do j = jsc, jec ; do i = isc, iec  !{
       jno3(i,j,k) =  jprod_no3nitrif(i,j,k) - phyto(DIAZO)%juptake_no3(i,j,k) - & 
                             phyto(LARGE)%juptake_no3(i,j,k) - phyto(SMALL)%juptake_no3(i,j,k) - &
                             jno3denit_wc(i,j,k) - juptake_no3amx(i,j,k)
       p_no3(i,j,k,tau) = p_no3(i,j,k,tau) + &
               (jno3(i,j,k)+jno3_iceberg(i,j,k))*dt*grid_tmask(i,j,k)
!    enddo; enddo ; enddo  !} i,j,k
    !
    !     Other nutrients
    !
!    do k = 1, nk ; do j = jsc, jec ; do i = isc, iec  !{
       ...
       jnh4(i,j,k) = jprod_nh4(i,j,k) - phyto(DIAZO)%juptake_nh4(i,j,k) - &
                            ...
                            juptake_nh4nitrif(i,j,k) - juptake_nh4amx(i,j,k)
       ...
       p_po4(i,j,k,tau) = p_po4(i,j,k,tau) + &
              (jpo4(i,j,k)+jpo4_iceberg(i,j,k)) * dt * grid_tmask(i,j,k)
       !
       ! SiO4
       !
...
!    do k = 1, nk ; do j = jsc, jec ; do i = isc, iec  !{
       ...
       ! Fed
       !
       jfed(i,j,k) = jprod_fed(i,j,k) + jfe_coast(i,j,k) + &
                            jfe_iceberg(i,j,k) - phyto(DIAZO)%juptake_fe(i,j,k) - &
...
!    do k = 1, nk ; do j = jsc, jec ; do i = isc, iec  !{
       ...
       jalk(i,j,k) = 2.0 * (jdiss_cadet_arag(i,j,k) +        &
          ...
          phyto(LARGE)%juptake_no3(i,j,k) + phyto(SMALL)%juptake_no3(i,j,k) + &
          (jo2resp_wc(i,j,k)-juptake_nh4nitrif(i,j,k)*o2_2_nitrif)/o2_2_nh4 + &
          alk_2_n_denit*jno3denit_wc(i,j,k) - & 
          alk_2_nh4_amx*juptake_nh4amx(i,j,k) - & 
          phyto(DIAZO)%juptake_nh4(i,j,k) - phyto(LARGE)%juptake_nh4(i,j,k) - &  
          phyto(SMALL)%juptake_nh4(i,j,k) - alk_2_nh4_nit*juptake_nh4nitrif(i,j,k)
...
!    call mpp_clock_begin(id_clock_cobalt_calc_diagnostics)
    ...
    !set btfs
    if (do_14c) call g_tracer_set_values(tracer_list,'di14c','btf',b_di14c,isd,jsd)
    ...
    do concurrent(k=1:nk,j=jsc:jec,i=isc:iec) local(imbal)
    !do k = 1, nk ; do j = jsc, jec ; do i = isc, iec  !{
         ...
         if (abs(imbal).gt.1.0e-9) then
           ...
           print*,'==>biological source/sink imbalance (generic_COBALT_update_from_source): Nitrogen'
         endif
        ...
        imbal = (post_totc(i,j,k) - pre_totc(i,j,k))*86400.0/dt*1.03e6
         if (abs(imbal).gt.1.0e-9) then
           !call mpp_error(FATAL,&
           print*,'==>biological source/sink imbalance (generic_COBALT_update_from_source): Carbon'
         endif
         ...
         if (abs(imbal).gt.1.0e-9) then
           !call mpp_error(FATAL,&
           print*,'==>biological source/sink imbalance (generic_COBALT_update_from_source): Phosphorus'
         endif
         ...
         if (abs(imbal).gt.1.0e-9) then
           !call mpp_error(FATAL,&
           print*,'==>biological source/sink imbalance (generic_COBALT_update_from_source): Iron'
         endif
         ...
         if (abs(imbal).gt.1.0e-9) then
           !call mpp_error(FATAL,&
           print*,'==>biological source/sink imbalance (generic_COBALT_update_from_source): Silica'
         endif
    enddo !docon
    !enddo; enddo ; enddo  !} i,j,k
    ...
    !
    do concurrent(k=1:nk,j=jsc:jec,i=isc:iec)
    tot_layer_int_c(i,j,k) = (p_dic(i,j,k,tau) + doc_background + p_cadet_arag(i,j,k,tau) +&
         p_cadet_calc(i,j,k,tau) + c_2_n * (p_ndi(i,j,k,tau) + p_nlg(i,j,k,tau) +      &
         p_nsm(i,j,k,tau) + p_nbact(i,j,k,tau) + &
         p_ldon(i,j,k,tau) + p_sldon(i,j,k,tau) + p_srdon(i,j,k,tau) +  &
         p_ndet(i,j,k,tau) + p_nsmz(i,j,k,tau) + p_nmdz(i,j,k,tau) + &
         p_nlgz(i,j,k,tau))) * rho_dzt(i,j,k)

    tot_layer_int_fe(i,j,k) = (p_fed(i,j,k,tau) + p_fedi(i,j,k,tau) + &
         p_felg(i,j,k,tau) + p_fesm(i,j,k,tau) + & 
         p_fedet(i,j,k,tau)) * rho_dzt(i,j,k) 

    tot_layer_int_n(i,j,k) = (p_no3(i,j,k,tau) + &
         p_nh4(i,j,k,tau) + p_ndi(i,j,k,tau) + p_nlg(i,j,k,tau) + &
         p_nsm(i,j,k,tau) + p_nbact(i,j,k,tau) + &
         p_ldon(i,j,k,tau) + p_sldon(i,j,k,tau) + p_srdon(i,j,k,tau) +  p_ndet(i,j,k,tau) + &
         p_nsmz(i,j,k,tau) + p_nmdz(i,j,k,tau) + p_nlgz(i,j,k,tau)) * & 
         rho_dzt(i,j,k)

    tot_layer_int_p(i,j,k) = (p_po4(i,j,k,tau) + &
         p_ndi(i,j,k,tau)*phyto(1)%p_2_n_static + &
         p_nlg(i,j,k,tau)*phyto(2)%p_2_n_static + &
         p_nsm(i,j,k,tau)*phyto(3)%p_2_n_static + &
         p_ldop(i,j,k,tau) + p_sldop(i,j,k,tau) + &
         p_srdop(i,j,k,tau) + p_pdet(i,j,k,tau) + &
         bact(1)%q_p_2_n*p_nbact(i,j,k,tau) + zoo(1)%q_p_2_n*p_nsmz(i,j,k,tau) +  &
         zoo(2)%q_p_2_n*p_nmdz(i,j,k,tau) + zoo(3)%q_p_2_n*p_nlgz(i,j,k,tau))  &
         * rho_dzt(i,j,k)

    tot_layer_int_si(i,j,k) = (p_sio4(i,j,k,tau) + p_silg(i,j,k,tau) +   &
         p_sidet(i,j,k,tau)) * rho_dzt(i,j,k)

    tot_layer_int_o2(i,j,k) = p_o2(i,j,k,tau)*rho_dzt(i,j,k)

    tot_layer_int_alk(i,j,k) = p_alk(i,j,k,tau)*rho_dzt(i,j,k)

    tot_layer_int_dic(i,j,k) = p_dic(i,j,k,tau)*rho_dzt(i,j,k)

    ! CAS: background excluded in accordance with CMIP6 request
    tot_layer_int_doc(i,j,k) = c_2_n * (p_ldon(i,j,k,tau) + p_sldon(i,j,k,tau) +  &
         p_srdon(i,j,k,tau)) * rho_dzt(i,j,k)

   tot_layer_int_poc(i,j,k) = (p_ndi(i,j,k,tau) + p_nlg(i,j,k,tau) + p_nsm(i,j,k,tau) + &
         p_nbact(i,j,k,tau) + p_ndet(i,j,k,tau) + p_nsmz(i,j,k,tau) + p_nmdz(i,j,k,tau) + &
         p_nlgz(i,j,k,tau))*c_2_n*rho_dzt(i,j,k)
   enddo !docon3

    call mpp_clock_end(id_clock_doloops)
    ...
    !do j = jsc, jec ; do i = isc, iec !{
       ...
       wc_vert_int_chemoautopp(i,j) = 0.0
       wc_vert_int_net_phyto_resp(i,j) = 0.0
       wc_vert_int_npp(i,j) = 0.0
       ...
       wc_vert_int_jprod_no3nitrif(i,j) = 0.0
       wc_vert_int_juptake_nh4(i,j) = 0.0
       wc_vert_int_jprod_nh4(i,j) = 0.0
       wc_vert_int_juptake_no3(i,j) = 0.0
       wc_vert_int_nfix(i,j) = 0.0
       wc_vert_int_jfe_iceberg(i,j) = 0.0
       wc_vert_int_jno3_iceberg(i,j) = 0.0
       wc_vert_int_jpo4_iceberg(i,j) = 0.0
       wc_vert_int_jprod_n2amx(i,j) = 0.0
!    enddo; enddo !} i,j
!    do j = jsc, jec ; do i = isc, iec 
       do k = 1, nk  !{
          ...
          wc_vert_int_chemoautopp(i,j) = wc_vert_int_chemoautopp(i,j) +                 &
             (bact(1)%jprod_n_nitrif(i,j,k) + bact(1)%jprod_n_amx(i,j,k)) * rho_dzt(i,j,k) * grid_tmask(i,j,k)
          wc_vert_int_net_phyto_resp(i,j) = wc_vert_int_net_phyto_resp(i,j) +                 &
             net_phyto_resp(i,j,k) * rho_dzt(i,j,k) * grid_tmask(i,j,k)
          wc_vert_int_npp(i,j) = wc_vert_int_npp(i,j) + (phyto(SMALL)%jprod_n(i,j,k) +  &
          ...
          wc_vert_int_jprod_no3nitrif(i,j) = wc_vert_int_jprod_no3nitrif(i,j) +                         &
             jprod_no3nitrif(i,j,k) * rho_dzt(i,j,k) * grid_tmask(i,j,k)
          ...
          wc_vert_int_nfix(i,j) = wc_vert_int_nfix(i,j) + phyto(DIAZO)%juptake_n2(i,j,k) *&
             rho_dzt(i,j,k) * grid_tmask(i,j,k)
          wc_vert_int_jprod_n2amx(i,j)=wc_vert_int_jprod_n2amx(i,j)+jprod_n2amx(i,j,k)* &
             rho_dzt(i,j,k) * grid_tmask(i,j,k)
		  
          wc_vert_int_jfe_iceberg(i,j) = wc_vert_int_jfe_iceberg(i,j) + jfe_iceberg(i,j,k) *&
             rho_dzt(i,j,k) * grid_tmask(i,j,k)
          wc_vert_int_jno3_iceberg(i,j) = wc_vert_int_jno3_iceberg(i,j) + jno3_iceberg(i,j,k) *&
             rho_dzt(i,j,k) * grid_tmask(i,j,k)
          wc_vert_int_jpo4_iceberg(i,j) = wc_vert_int_jpo4_iceberg(i,j) + jpo4_iceberg(i,j,k) *&
             rho_dzt(i,j,k) * grid_tmask(i,j,k) 
...
!    enddo; enddo  !} i,j,k
    ...
    do j = jsc, jec ; do i = isc, iec  !{
      ...
      if (k .gt. 0) then !{
        do k = grid_kmt(i,j),1,-1   !{
          if (rho_dzt_bot(i,j).lt.Rho_0*1.0) then
    ...
    do concurrent(j=jsc:jec,i=isc:iec) local(k)
    !do j = jsc, jec ; do i = isc, iec  !{
      k = grid_kmt(i,j)
      if (k .gt. 0) then !{
        do k = grid_kmt(i,j),k_bot(i,j),-1   !{
          jdiss_cadet_calc_plus_btm(i,j,k) = jdiss_cadet_calc(i,j,k) +  &
            fcased_redis(i,j) / rho_dzt_bot(i,j)
          jdiss_cadet_arag_plus_btm(i,j,k)  = jdiss_cadet_arag(i,j,k) +  &
            f_cadet_arag_btf(i,j,1) / rho_dzt_bot(i,j)
          jprod_nh4_plus_btm(i,j,k) = jprod_nh4(i,j,k) + &
            (f_ndet_btf(i,j,1) - fndet_burial(i,j)) / rho_dzt_bot(i,j)
          jalk_plus_btm(i,j,k) = jalk(i,j,k) +                       &
            (2.0 * (fcased_redis(i,j) + f_cadet_arag_btf(i,j,1)) +    &
            f_ndet_btf(i,j,1) + alk_2_n_denit * fno3denit_sed(i,j)) / &
            rho_dzt_bot(i,j)
          jdic_plus_btm(i,j,k) = jdic(i,j,k) +                       &
             ...
             rho_dzt_bot(i,j)
          jfed_plus_btm(i,j,k) = jfed(i,j,k) + &
             (ffe_sed(i,j)+ffe_geotherm(i,j)) / rho_dzt_bot(i,j)
          jnh4_plus_btm(i,j,k) = jnh4(i,j,k) + &
             (f_ndet_btf(i,j,1) - fndet_burial(i,j)) / rho_dzt_bot(i,j)
          jno3_plus_btm(i,j,k) = jno3(i,j,k) - &
             fno3denit_sed(i,j) / rho_dzt_bot(i,j)
          jo2_plus_btm(i,j,k) = jo2(i,j,k) + &
             (o2_2_nh4 * (fnoxic_sed(i,j) + fnfeso4red_sed(i,j))) / &
             rho_dzt_bot(i,j)
          jpo4_plus_btm(i,j,k) = jpo4(i,j,k) + &
             (f_pdet_btf(i,j,1) - fpdet_burial(i,j)) / rho_dzt_bot(i,j)
          jsio4_plus_btm(i,j,k) = jsio4(i,j,k) + &
             f_sidet_btf(i,j,1) / rho_dzt_bot(i,j)
          jdin_plus_btm(i,j,k)  = jno3_plus_btm(i,j,k) + &
             jnh4_plus_btm(i,j,k)
        enddo
      endif
    !enddo; enddo
...
! added juptake_sio4_100 (large only)
    ...
    call g_tracer_get_values(tracer_list,'pdet','runoff_tracer_flux',runoff_flux_pdet,isd,jsd)
...
! Send phytoplankton diagnostic data
   ...
   if (id_jprod_nh4_plus_btm .gt. 0)          &
    ...
    if (id_jprod_po4 .gt. 0)          &
        ...
        model_time, rmask = grid_tmask,&
        is_in=isc, js_in=jsc, ks_in=1,ie_in=iec, je_in=jec, ke_in=nk)
    if (id_net_phyto_resp .gt. 0)          &
        used = g_send_data(id_net_phyto_resp, net_phyto_resp*rho_dzt,           &
        model_time, rmask = grid_tmask,&
        is_in=isc, js_in=jsc, ks_in=1,ie_in=iec, je_in=jec, ke_in=nk)
    ...
    if (id_jfe_coast .gt. 0)            &
         ...
         model_time, rmask = grid_tmask,&
         is_in=isc, js_in=jsc, ks_in=1,ie_in=iec, je_in=jec, ke_in=nk)
     if (id_jfe_iceberg .gt. 0)            &
         used = g_send_data(id_jfe_iceberg, jfe_iceberg*rho_dzt,         &
         model_time, rmask = grid_tmask,&
         is_in=isc, js_in=jsc, ks_in=1,ie_in=iec, je_in=jec, ke_in=nk)
      if (id_jno3_iceberg .gt. 0)            &
         used = g_send_data(id_jno3_iceberg, jno3_iceberg*rho_dzt,         &
         model_time, rmask = grid_tmask,&
         is_in=isc, js_in=jsc, ks_in=1,ie_in=iec, je_in=jec, ke_in=nk)
      if (id_jpo4_iceberg .gt. 0)            &
         used = g_send_data(id_jpo4_iceberg, jpo4_iceberg*rho_dzt,         &
         model_time, rmask = grid_tmask,&
         is_in=isc, js_in=jsc, ks_in=1,ie_in=iec, je_in=jec, ke_in=nk)
    ...
    if (id_jno3denit_wc .gt. 0)            &
         ...
         model_time, rmask = grid_tmask,&
         is_in=isc, js_in=jsc, ks_in=1,ie_in=iec, je_in=jec, ke_in=nk)
    if (id_juptake_nh4amx .gt. 0)            &
         used = g_send_data(id_juptake_nh4amx, juptake_nh4amx*rho_dzt,  &
         model_time, rmask = grid_tmask,&
         is_in=isc, js_in=jsc, ks_in=1,ie_in=iec, je_in=jec, ke_in=nk)
    if (id_juptake_no3amx .gt. 0)            &
         used = g_send_data(id_juptake_no3amx, juptake_no3amx*rho_dzt,  &
         model_time, rmask = grid_tmask,&
         is_in=isc, js_in=jsc, ks_in=1,ie_in=iec, je_in=jec, ke_in=nk)
    if (id_jo2resp_wc .gt. 0)            &
         ...
         model_time, rmask = grid_tmask,&
         is_in=isc, js_in=jsc, ks_in=1,ie_in=iec, je_in=jec, ke_in=nk)
    if (id_jprod_no3nitrif .gt. 0)              &
         used = g_send_data(id_jprod_no3nitrif, jprod_no3nitrif*rho_dzt,       &
         model_time, rmask = grid_tmask,&
         is_in=isc, js_in=jsc, ks_in=1,ie_in=iec, je_in=jec, ke_in=nk)
    if (id_juptake_nh4nitrif .gt. 0)              &
         used = g_send_data(id_juptake_nh4nitrif, juptake_nh4nitrif*rho_dzt,       &
         model_time, rmask = grid_tmask,&
         is_in=isc, js_in=jsc, ks_in=1,ie_in=iec, je_in=jec, ke_in=nk)
    if (id_jprod_n2amx .gt. 0)              &
         used = g_send_data(id_jprod_n2amx, jprod_n2amx*rho_dzt,       &
         model_time, rmask = grid_tmask,&
         is_in=isc, js_in=jsc, ks_in=1,ie_in=iec, je_in=jec, ke_in=nk)
...
!
   ...
   if (id_btm_co3_sol_calc .gt. 0)            &
    ...
    if (id_runoff_flux_ndet .gt. 0)     &
       ...
       model_time, rmask = grid_tmask(:,:,1),&
       is_in=isc, js_in=jsc, ie_in=iec, je_in=jec)
    if (id_runoff_flux_pdet .gt. 0)     &
       used = g_send_data(id_runoff_flux_pdet, runoff_flux_pdet,           &
       model_time, rmask = grid_tmask(:,:,1),&
       is_in=isc, js_in=jsc, ie_in=iec, je_in=jec)
   ...
   if (phyto(LARGE)%id_jaggloss_n_100 .gt. 0)     &
    ...
    if (id_wc_vert_int_alk .gt. 0)       &
       ...
       model_time, rmask = grid_tmask(:,:,1),&
       is_in=isc, js_in=jsc, ie_in=iec, je_in=jec)
    if (id_wc_vert_int_chemoautopp .gt. 0)       &
       used = g_send_data(id_wc_vert_int_chemoautopp, wc_vert_int_chemoautopp, &
       model_time, rmask = grid_tmask(:,:,1),&
       is_in=isc, js_in=jsc, ie_in=iec, je_in=jec)
    if (id_wc_vert_int_net_phyto_resp .gt. 0)       &
       used = g_send_data(id_wc_vert_int_net_phyto_resp, wc_vert_int_net_phyto_resp, &
       model_time, rmask = grid_tmask(:,:,1),&
       is_in=isc, js_in=jsc, ie_in=iec, je_in=jec)
    if (id_wc_vert_int_npp .gt. 0)       &
       used = g_send_data(id_wc_vert_int_npp,    wc_vert_int_npp,         &
       model_time, rmask = grid_tmask(:,:,1),&
       is_in=isc, js_in=jsc, ie_in=iec, je_in=jec)
    ...
    if (id_wc_vert_int_jno3denit .gt. 0)       &
       ...
       model_time, rmask = grid_tmask(:,:,1),&
       is_in=isc, js_in=jsc, ie_in=iec, je_in=jec)
    if (id_wc_vert_int_jprod_no3nitrif .gt. 0)       &
       used = g_send_data(id_wc_vert_int_jprod_no3nitrif,    wc_vert_int_jprod_no3nitrif,  &
       model_time, rmask = grid_tmask(:,:,1),&
       is_in=isc, js_in=jsc, ie_in=iec, je_in=jec)
    if (id_wc_vert_int_jprod_n2amx .gt. 0)       &
       used = g_send_data(id_wc_vert_int_jprod_n2amx,    wc_vert_int_jprod_n2amx,  &
       model_time, rmask = grid_tmask(:,:,1),&
       is_in=isc, js_in=jsc, ie_in=iec, je_in=jec)
    ...
    if (id_wc_vert_int_nfix .gt. 0)       &
       ...
       model_time, rmask = grid_tmask(:,:,1),&
       is_in=isc, js_in=jsc, ie_in=iec, je_in=jec)
    if (id_wc_vert_int_jfe_iceberg .gt. 0)       &
       used = g_send_data(id_wc_vert_int_jfe_iceberg,    wc_vert_int_jfe_iceberg,  &
       model_time, rmask = grid_tmask(:,:,1),&
       is_in=isc, js_in=jsc, ie_in=iec, je_in=jec)
    if (id_wc_vert_int_jno3_iceberg .gt. 0)       &
       used = g_send_data(id_wc_vert_int_jno3_iceberg,    wc_vert_int_jno3_iceberg,  &
       model_time, rmask = grid_tmask(:,:,1),&
       is_in=isc, js_in=jsc, ie_in=iec, je_in=jec)
    if (id_wc_vert_int_jpo4_iceberg .gt. 0)       &
       used = g_send_data(id_wc_vert_int_jpo4_iceberg,    wc_vert_int_jpo4_iceberg,  &
       model_time, rmask = grid_tmask(:,:,1),&
       is_in=isc, js_in=jsc, ie_in=iec, je_in=jec)
    !
    !---------------------------------------------------------------------
...
!         is_in=isc, js_in=jsc, ks_in=1,ie_in=iec, je_in=jec, ke_in=nk)
    ...
    dissoc(:,:,:) = c_2_n * (p_ldon(:,:,:,tau) + p_sldon(:,:,:,tau) + &
                                           p_srdon(:,:,:,tau) ) 
...
! CAS: added jprod_nh4_plus_btm to calculate
    if (id_remoc .gt. 0)            &
        used = g_send_data(id_remoc,  jprod_nh4_plus_btm*c_2_n*Rho_0,  &
        model_time, rmask = grid_tmask,&
        is_in=isc, js_in=jsc, ks_in=1,ie_in=iec, je_in=jec, ke_in=nk)

! CAS: added redissolution from sediment
    if (id_dcalc .gt. 0)            &
        used = g_send_data(id_dcalc,  jdiss_cadet_calc_plus_btm*Rho_0, &
        model_time, rmask = grid_tmask,&
        is_in=isc, js_in=jsc, ks_in=1,ie_in=iec, je_in=jec, ke_in=nk)

! CAS: added redissolution from sediment
    if (id_darag .gt. 0)            &
        used = g_send_data(id_darag,  jdiss_cadet_arag_plus_btm*Rho_0, &
        model_time, rmask = grid_tmask,&
        is_in=isc, js_in=jsc, ks_in=1,ie_in=iec, je_in=jec, ke_in=nk)
...
!        is_in=isc, js_in=jsc, ie_in=iec, je_in=jec)
    ...
    if (id_popos .gt. 0)            &
        used = g_send_data(id_popos,  ((phyto(DIAZO)%p_2_n_static * p_ndi(:,:,1,tau)) + &
        phyto(LARGE)%p_2_n_static*p_nlg(:,:,1,tau) + phyto(SMALL)%p_2_n_static*p_nsm(:,:,1,tau) + &
        bact(1)%q_p_2_n*p_nbact(:,:,1,tau) +  p_pdet(:,:,1,tau) + &
        zoo(1)%q_p_2_n*p_nsmz(:,:,1,tau) + zoo(2)%q_p_2_n*p_nmdz(:,:,1,tau) + &
        zoo(3)%q_p_2_n*p_nlgz(:,:,1,tau)) * Rho_0,  &
        model_time, rmask = grid_tmask(:,:,1),&
        is_in=isc, js_in=jsc, ie_in=iec, je_in=jec)
    ...
    if (id_phypos .gt. 0)            &
        used = g_send_data(id_phypos,  (phyto(DIAZO)%p_2_n_static*p_ndi(:,:,1,tau) + &
        phyto(LARGE)%p_2_n_static*p_nlg(:,:,1,tau) + &
        phyto(SMALL)%p_2_n_static*p_nsm(:,:,1,tau))*Rho_0,  &
        model_time, rmask = grid_tmask(:,:,1),&
        is_in=isc, js_in=jsc, ie_in=iec, je_in=jec)
...
!      aragonite flux to the sediment (which is instantaneously redissolved) 
    if (id_icfriver .gt. 0)            &
        used = g_send_data(id_icfriver,  runoff_flux_dic + fcased_redis + &
        fcadet_arag_btm,model_time, rmask = grid_tmask(:,:,1),&
        is_in=isc, js_in=jsc, ie_in=iec, je_in=jec)

! CAS: Updated on 3/9/2021 to exclude calcite dissolution but include the aragonite flux to 
!      the bottom
    if (id_fric .gt. 0)            &
        used = g_send_data(id_fric,  fcadet_calc_btm + fcadet_arag_btm,  &
        model_time, rmask = grid_tmask(:,:,1),&
        is_in=isc, js_in=jsc, ie_in=iec, je_in=jec)
...
!      equal to the total flux, not just the burial
    if (id_froc .gt. 0)            &
        used = g_send_data(id_froc,c_2_n*fndet_btm, & 
        model_time, rmask = grid_tmask(:,:,1),&
        is_in=isc, js_in=jsc, ie_in=iec, je_in=jec)
...
! CAS: Updated on 3/9/2021 to include nh4 deposition and riverine fluxes of organic nitrogen
    if (id_fsn .gt. 0)            &
        used = g_send_data(id_fsn,  runoff_flux_no3 + dry_no3 + wet_no3 + &
        dry_nh4 + wet_nh4 + runoff_flux_ldon + runoff_flux_sldon + &
        runoff_flux_srdon + wc_vert_int_nfix,  &
        model_time, rmask = grid_tmask(:,:,1),&
        is_in=isc, js_in=jsc, ie_in=iec, je_in=jec)

! JYL: Updated on 3/21/2021 to include anammox
    if (id_frn .gt. 0)            &
        used = g_send_data(id_frn,  fno3denit_sed + wc_vert_int_jno3denit + &
        wc_vert_int_jprod_n2amx + fndet_burial, &
        model_time, rmask = grid_tmask(:,:,1),&
        is_in=isc, js_in=jsc, ie_in=iec, je_in=jec)
...
! CAS: Updated on 3/9/2021 to include ffe_iceberg
    if (id_fsfe .gt. 0)            &
        ...
        ffe_sed+ffe_geotherm+ffe_iceberg, &
        model_time, rmask = grid_tmask(:,:,1),&
        is_in=isc, js_in=jsc, ie_in=iec, je_in=jec)
...
!
  ...
  subroutine user_allocate_arrays
    ...
    allocate(net_phyto_resp(isd:ied, jsd:jed, 1:nk)) ; net_phyto_resp=0.0
    ...
    allocate(jfe_iceberg(isd:ied, jsd:jed, 1:nk))  ; jfe_iceberg=0.0
    allocate(jno3_iceberg(isd:ied, jsd:jed, 1:nk)) ; jno3_iceberg=0.0
    allocate(jpo4_iceberg(isd:ied, jsd:jed, 1:nk)) ; jpo4_iceberg=0.0
    ...
    allocate(juptake_no3amx(isd:ied, jsd:jed, 1:nk))   ; juptake_no3amx=0.0
    allocate(juptake_nh4amx(isd:ied, jsd:jed, 1:nk))   ; juptake_nh4amx=0.0
    allocate(jo2resp_wc(isd:ied, jsd:jed, 1:nk))   ; jo2resp_wc=0.0
    allocate(jprod_no3nitrif(isd:ied, jsd:jed, 1:nk)) ; jprod_no3nitrif=0.0
    allocate(juptake_nh4nitrif(isd:ied, jsd:jed, 1:nk)) ; juptake_nh4nitrif=0.0
    allocate(jprod_n2amx(isd:ied, jsd:jed, 1:nk)) ; jprod_n2amx=0.0
...
! JGJ 2016/08/08 CMIP6 OcnBgchem 
    ...
    allocate(wc_vert_int_chemoautopp(isd:ied, jsd:jed)) ; wc_vert_int_chemoautopp=0.0
    allocate(wc_vert_int_net_phyto_resp(isd:ied, jsd:jed))  ; wc_vert_int_net_phyto_resp=0.0
    allocate(wc_vert_int_npp(isd:ied, jsd:jed))     ; wc_vert_int_npp=0.0
    ...
    allocate(wc_vert_int_jprod_no3nitrif(isd:ied, jsd:jed)) ; wc_vert_int_jprod_no3nitrif=0.0
    allocate(wc_vert_int_jprod_n2amx(isd:ied, jsd:jed)) ; wc_vert_int_jprod_n2amx=0.0
    ...
    allocate(wc_vert_int_jfe_iceberg(isd:ied, jsd:jed))  ; wc_vert_int_jfe_iceberg=0.0
    allocate(wc_vert_int_jno3_iceberg(isd:ied, jsd:jed))  ; wc_vert_int_jno3_iceberg=0.0
    allocate(wc_vert_int_jpo4_iceberg(isd:ied, jsd:jed))  ; wc_vert_int_jpo4_iceberg=0.0
!==============================================================================================================
    !
   ...
   if (do_14c) then                                        !<<RADIOCARBON
      ...
      allocate(runoff_flux_pdet(isd:ied, jsd:jed));     runoff_flux_pdet=0.0
  ...
  subroutine user_deallocate_arrays
    ...
    deallocate(jfe_iceberg)
    deallocate(jno3_iceberg)
    deallocate(jpo4_iceberg)
    ...
    deallocate(juptake_no3amx)
    deallocate(juptake_nh4amx)
    deallocate(jo2resp_wc)  
    deallocate(jprod_no3nitrif)
    deallocate(juptake_nh4nitrif) 
    deallocate(jprod_n2amx)
...
! JGJ 2016/08/08 CMIP6 OcnBgchem 
    ...
    deallocate(wc_vert_int_chemoautopp)
    deallocate(wc_vert_int_net_phyto_resp)
    deallocate(wc_vert_int_npp)
    ...
    deallocate(wc_vert_int_jprod_no3nitrif)
    deallocate(wc_vert_int_jprod_n2amx)
    ...
    deallocate(wc_vert_int_jfe_iceberg)
    deallocate(wc_vert_int_jno3_iceberg)
    deallocate(wc_vert_int_jpo4_iceberg)  
!==============================================================================================================
